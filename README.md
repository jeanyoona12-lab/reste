...
[개발:  기능]
* 3D 모델을 웹에 구현하기, 상품 별 상세페이지 제작 후 라우터를 활용해 각각 연결시킴
...
## 7. 트러블 슈팅
문제 1. 간략한 내용
상황: 조원 간 시간 배율이 맞지 않아서 내가 생각 했던 작업 진행속도가 차이가 났다
해결: 손이 느린 조원에게 충분한 시간을 주고 시간 내 완성 하도록 조언해줬다
과정: -
